...
const Nav = () => {
  ...
  return (
    <nav className="bg-gray-600 flex justify-between items-center py-6 px-[15vw]">
      <div className="logo mx-4 flex">
        <Image width={90} height={180} src="https://seasons.jdprojects.in/assets/img/logo/logo-white.png" alt="logo" />
      ...
      {/* Desktop - Nav Links */}
      <ul className="hidden md:flex space-x-6 text-white text-[12px] mx-4">
        <li>Home</li>
        <li>Features</li>
        <li>Pages</li>
        <li>Blogs</li>
      ...
      <div className="contact-container flex items-center space-x-2">
        <div className="flex items-center justify-center w-8 h-8 space-x-2 bg-white rounded-full shadow-md ">
          <svg className="w-5 h-5 text-gray-700" viewBox="0 0 21 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <div className="flex flex-col text-white">
          ...
          <Link href="tel:+913333333" className="text-[12px] font-bold">
            +91-3333333456
          </Link>
        </div>
      </div>
