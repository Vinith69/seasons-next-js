...
const Button = ({ hrefPath }: ButtonProps) => {
  return (
    <Link href={hrefPath}>
      <button className="text-white cursor-pointer rounded-sm text-[10px] font-bold flex justify-center items-center w-20 h-7 bg-[#FFFFFF30] hover:bg-white hover:text-black transition-all duration-300 hover:shadow-sm">
        <span className="mx-1">
